...
""" Удаляем записи из таблицы  order_details, где product_id соответствует которые discontinued = 1, далее удлаяем из таблицы products товары, которые discontinued = 1. """
